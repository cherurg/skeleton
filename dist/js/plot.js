...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCoffee = __webpack_require__(2);

	var _WrapCoffee = __webpack_require__(159);

	var _WrapCoffee2 = _interopRequireDefault(_WrapCoffee);

	var _Plotter = __webpack_require__(168);

	var _Plotter2 = _interopRequireDefault(_Plotter);

	var _OverContainer = __webpack_require__(199);
	...
	var PlotContainer = (function () {
	  function PlotContainer(elementID) {
	    ...
	    this.attrs = (0, _utilsCoffee.extend)({}, options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _, clone, each, extend, filter, isFunction, isNumber, isString, keys, pick, sortBy;
	...
	_.extendDefaults = function(object, options) {
	  return extend(object, object.defaults, pick(options, keys(object.defaults)));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFlatten = __webpack_require__(38),
	    basePick = __webpack_require__(41),
	    rest = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayPush = __webpack_require__(39),
	    isFlattenable = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneArrayBuffer = __webpack_require__(93),
	    cloneDataView = __webpack_require__(95),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFlatten = __webpack_require__(38),
	    baseOrderBy = __webpack_require__(112),
	    isArray = __webpack_require__(35),
	    isFlattenableIteratee = __webpack_require__(153),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(113),
	    ...
	    compareMultiple = __webpack_require__(151),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compareAscending = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wrap, find, isNumber, last, remove;
	...
	Wrap = (function() {
	  ...
	  Wrap.prototype.remove = function(el) {
	    ...
	    dead = find(this.arr, finder);
	    if (dead == null) {
	      console.log("remove: не найден элемент " + el);
	      return;
	    }
	    remove(this.arr, function(o) {
	      return o === dead;
	    });
	    return dead;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(114),
	    basePullAt = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ParametricFuncCoffee = __webpack_require__(198);

	var _ParametricFuncCoffee2 = _interopRequireDefault(_ParametricFuncCoffee);

	var _eventEmitter = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ee = __webpack_require__(171);

	SaveSvg = __webpack_require__(186);

	SavePng = __webpack_require__(187);

	PlotPure = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d        = __webpack_require__(172)
	  , callable = __webpack_require__(185)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign        = __webpack_require__(173)
	  , normalizeOpts = __webpack_require__(180)
	  , isCallable    = __webpack_require__(181)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libsD3D3Js = __webpack_require__(1);

	var _libsD3D3Js2 = _interopRequireDefault(_libsD3D3Js);

	var SaveSvg = function SaveSvg(id) {
	            var xml = _libsD3D3Js2["default"].select(id).select("svg").attr("version", 1.1).attr("xmlns", "http://www.w3.org/2000/svg").node().outerHTML;
	            var imgsrc = 'data:image/svg+xml;base64,' + btoa(unescape(encodeURIComponent(xml)));
	            var a = _libsD3D3Js2["default"].select('body').append("a").attr('download', 'graph.svg').attr('href', imgsrc).node().click();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SavePng = function SavePng(id) {
	  var canvas = _libsD3D3Js2['default'].select('body').append('canvas').style('display', 'none');
	  var context = canvas.node().getContext("2d");
	  var xml = _libsD3D3Js2['default'].select(id).select("svg").attr("version", 1.1).attr("xmlns", "http://www.w3.org/2000/svg").node().outerHTML;
	  var imgsrc = 'data:image/svg+xml;base64,' + btoa(unescape(encodeURIComponent(xml)));
	  var image = new Image();
	  image.src = imgsrc;
	  canvas.attr('width', _libsD3D3Js2['default'].select('svg').attr('width'));
	  canvas.attr('height', _libsD3D3Js2['default'].select('svg').attr('height'));
	  context.fillStyle = 'white';
	  context.fillRect(0, 0, canvas.attr('width'), canvas.attr('height'));
	  context.drawImage(image, 0, 0);
	  var canvasdata = canvas.node().toDataURL("image/png");
	  var pngimg = '<img src="' + canvasdata + '">';
	  _libsD3D3Js2['default'].select("#pngdataurl").html(pngimg);
	  var a = _libsD3D3Js2['default'].select('body').append('a').attr('download', 'graph.png').attr('href', canvasdata).node().click();
	  canvas.remove();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Colors = __webpack_require__(189)('Color');

	Colours = __webpack_require__(189)('Colour', 'color');

	PointPure = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Fill = __webpack_require__(189)('Fill');

	FuncPure = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ParametricArrayPure = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	LinePure = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ParametricArray = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GateCoffee = __webpack_require__(200);
